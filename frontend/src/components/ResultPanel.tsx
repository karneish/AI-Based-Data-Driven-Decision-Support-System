...
export default function ResultPanel({ result }: Props) {
  ...
  const radarData = Object.entries(result.radar_data).map(([subject, value]) => ({ subject, A: value, fullMark: 100 }))
    ...
    <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="glass-card p-6">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <RadarChart data={radarData} margin={{ top: 10, right: 30, bottom: 10, left: 30 }}>
              ...
              <Radar name="Student" dataKey="A" stroke="#33a4fc" fill="#33a4fc" fillOpacity={0.2} strokeWidth={2} dot={{ fill: '#33a4fc', r: 3 }} />
          ...
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={fiData} layout="vertical" margin={{ left: 10, right: 20 }}>
              ...
              <Bar dataKey="value" name="Importance %" radius={[0, 6, 6, 0]}>
                {fiData.map((_, i) => (
                  <Cell key={i} fill={['#33a4fc','#06d6f7','#a855f7','#10b981','#f59e0b','#ef4444','#8b5cf6','#14b8a6'][i % 8]} />
                ))}
              </Bar>
            </BarChart>
          </ResponsiveContainer>
      ...
      <div className="glass-card p-6">
        ...
        <ResponsiveContainer width="100%" height={280}>
          <BarChart data={result.bar_data} margin={{ top: 10, right: 20, left: 0, bottom: 10 }}>
            ...
            <Bar dataKey="score"     name="Student Score" fill="#33a4fc" radius={[6,6,0,0]} />
