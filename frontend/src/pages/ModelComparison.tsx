...
export default function ModelComparisonPage() {
  ...
  useEffect(() => {
    getModelComparison()
      .then(d => { setData(d); setSelectedModel(d.best_model) })
      .catch(() => setError('Could not load model comparison. Make sure the backend is running.'))
  ...
  const metricLabels: Record<string, string> = {
    ...
    f1_score: 'F1 Score', auc: 'AUC-ROC', cv_score: 'CV Score'
  }
